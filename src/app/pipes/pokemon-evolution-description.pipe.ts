...
export class PokemonEvolutionDescriptionPipe implements PipeTransform {
  transform(evDetail: EvolutionDetail | null): string {
    ...
    switch (evDetail.trigger.name) {
      case 'level-up':
        desc = this.getLevelUpDesc(evDetail)
        break
      case 'trade':
        desc = this.getTradeDesc(evDetail)
        break
      case 'use-item':
        desc = this.getUseItem(evDetail)
        break
      case 'shed':
      ...
      case 'tower-of-darkness':
        desc = 'Train in the Tower of Darkness/ Waters'
        break
  ...
  private getLevelUpDesc(evDetail: EvolutionDetail): string {
    let desc = ''
  ...
  private getTradeDesc(evDetail: EvolutionDetail): string {
    let desc = 'Trade'
  ...
  private getUseItem(evDetail: EvolutionDetail): string {
    let desc = 'Use'
